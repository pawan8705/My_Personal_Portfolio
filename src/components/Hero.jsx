  ...
  return (
    ...
    >
      ...
      <style>{`
        ...
        .hero-card-name {
          animation: nameEntry 0.6s cubic-bezier(0.22,1,0.36,1) 0.5s both;
        }
        .hero-card-glow {
      ...
      <div className="section-wrap w-full relative z-10">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 lg:gap-6 items-center">
          ...
          <div className="flex flex-col gap-5 order-2 lg:order-1 items-center lg:items-start text-center lg:text-left">
            ...
            <div
              className="hl inline-flex items-center gap-2 px-4 py-1.5 rounded-full text-[11px] font-bold tracking-[0.1em] uppercase"
              style={{
            ...
            <div className="hl flex items-center gap-3 justify-center lg:justify-start">
              ...
              <span
                ...
                style={{ color: 'var(--text2)', fontFamily: 'var(--mono)', minWidth: 200 }}
              >
            ...
            <p
              className="hl text-[0.92rem] leading-[1.85] max-w-[480px] mx-auto lg:mx-0"
            ...
            <div className="hl flex flex-wrap gap-3 justify-center lg:justify-start">
              ...
              <a
                href={Resume.link} target='_blank'
            ...
            <div className="hl flex flex-wrap gap-3 justify-center lg:justify-start">
              {stats.map(s => (
                ...
                >
                  <span className="font-black text-xl g-text leading-none" style={{ fontFamily: 'var(--font)' }}>
                    {s.value}
                  </span>
                  <span className="text-[10px] font-semibold uppercase tracking-wider mt-1" style={{ color: 'var(--text3)' }}>
                    {s.label}
                  </span>
                </div>
              ))}
